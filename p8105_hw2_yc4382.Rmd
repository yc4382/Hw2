...
```{r}
data2_mr = read_excel("C:\\grad\\202309 Trash Wheel Collection Data.xlsx",sheet=1,skip = 1,n_max = 584)
...
```{r}
data2_prof = read_excel("C:\\grad\\202309 Trash Wheel Collection Data.xlsx",sheet=2,skip = 1,n_max = 106)
...
data2_gwynnda = read_excel("C:\\grad\\202309 Trash Wheel Collection Data.xlsx",sheet=4,skip = 1,n_max = 155)
...
```{r}
data3_base = read.csv("C:\\Grad\\data_mci\\data_mci\\MCI_baseline.csv",skip = 1)
```
...
```{r}
data3_biomarker = read.csv("C:\\Grad\\data_mci\\data_mci\\mci_amyloid.csv",skip = 1)
